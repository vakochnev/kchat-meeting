FROM docker-kchat.compainy.ru/python:3.11-slim
...
RUN --mount=type=secret,id=pypi-username,env=PYPI_USERNAME \
    ...
    export PIP_INDEX_URL="https://$PYPI_USERNAME:$PYPI_PASSWORD@repo-ci.compainy.ru/repository/kchat-pypi-g/simple" && \
